...
object Constants {
    ...
    const val KEY_HOME_WIFI_SSIDS = "home_wifi_ssids"
    ...
    const val ACTION_CHECK_STATUS = "com.naul.workscheduler.ACTION_CHECK_STATUS"
    const val ACTION_LOGS_UPDATED = "com.naul.workscheduler.ACTION_LOGS_UPDATED"
    ...
    const val KEY_PRE_MUTE_ENABLED = "pre_mute_enabled"
}
